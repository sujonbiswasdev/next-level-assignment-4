    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3  gap-8">
        {filterData.length === 0 ? (
          ...
          filterData.map((meal: IGetMealData, index: number) => {
            return (
              <div key={index}>
                  ...
                  <CardHoverLift>
                    ...
                    <div className="p-6 space-y-3">
                      <div className="flex items-center justify-between">
                        <h2 className="text-xl font-bold text-gray-900">
                          {meal.meals_name.length > 5
                            ? `${meal.meals_name.slice(0, 5)}...`
                            : meal.meals_name}
                        </h2>
                    ...
                    <div className="flex justify-between meals-center ">
                      <Button
                        ...
                        className="px-4 bg-gradient-to-r from-gray-900 to-black text-white py-1.5 rounded-md font-semibold hover:from-gray-800 hover:shadow-2xl transition-all cursor-pointer mb-2 ml-3"
                      >
                        View Details →
                      </Button>
                      <Button
